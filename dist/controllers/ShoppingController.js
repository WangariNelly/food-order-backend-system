...
var GetTopRestaurants = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pincode = req.params.pincode;
                return [4 /*yield*/, models_1.Vendor.find({ pincode: pincode, serviceAvailable: false }).sort([['rating', 'descending']]).limit(10)];
            case 1:
                result = _a.sent();
                if (result.length > 0) {
                    return [2 /*return*/, res.status(200).json(result)];
...
var GetAvailableOffers = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pincode = req.params.pincode;
                return [4 /*yield*/, models_2.Offer.find({ pincode: pincode, isActive: true })];
            case 1:
                offers = _a.sent();
                if (offers) {

    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                _b.label = 3;
            case 3: return [2 /*return*/, res.json({ message: "Logins not valid!" })];
        }
    });
}); };
...
var GetVendorProfile = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2: return [2 /*return*/, res.json({ message: "Vendor Info not found" })];
        }
    });
}); };
exports.GetVendorProfile = GetVendorProfile;
var UpdateVendorProfile = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, address, foodTypes, phone, user, existingVendor, savedResult;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
...
var AddFood = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, _a, name, description, category, foodType, readyTime, price, vendor, files, images, createdFood, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                user = req.user;
